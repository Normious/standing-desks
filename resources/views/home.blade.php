...
<div class="container">
  ...
  <div class="container mx-auto px-4 py-8">
    <div class="container mt-5">
      <div class="text-center mb-5">
        ...
        <p class="lead">Explore our wide range of ergonomic standing desks and discover the health benefits of standing
          while working.</p>
  ...
  @endauth
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Great for small spaces, offering flexibility to convert any desk into a standing
                desk.</p>
              <a href="#" class="btn btn-primary">Learn More</a>
            </div>
          </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Easily adjust the height with the touch of a button for a seamless transition between
      ...
      <div class="text-center mt-5">
        ...
        <p class="lead mt-4">Discover the health benefits of standing desks, from improved posture to increased
          productivity.</p>
